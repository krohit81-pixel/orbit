...
1. **`../documents/orbit-master-context-v1.12.md`** — product intent, philosophy, guardrails,
   version history. Read this first.
2. **`../documents/engineering-reference-v1.12.md`** — architecture, components, design
   decisions, and its own §15 has the step-by-step build-a-feature checklist.

Before trusting the "v1.12" above, check `../documents/` for a higher-numbered pair — this

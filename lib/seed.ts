...
export function seedData(): SeedData {
  ...
  const meetings: Meeting[] = [
    ...
    },
    {
      ...
      commitments: [{ id: uid(), text: "Share risk-appetite summary", owedByMe: true, stakeholderId: s1, due: "This week", dueDate: isoIn(4), source: "I'll get you the one-pager", status: "open" }],
    ...
    },
    {
      ...
      commitments: [{ id: uid(), text: "Deliver AI governance proposal", owedByMe: true, stakeholderId: s1, due: "By the 30th", dueDate: isoIn(15), source: "I'll get you the proposal by the 30th", status: "open" }],
